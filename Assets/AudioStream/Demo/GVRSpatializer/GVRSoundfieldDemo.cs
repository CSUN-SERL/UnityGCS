...
public class GVRSoundfieldDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUILayout.Label("AudioStream v " + AudioStream.About.version + " © 2016-2018 Martin Cvengros, using FMOD Studio by Firelight Technologies" + (this.gVRSoundfield ? " " + this.gVRSoundfield.fmodVersion : ""), this.guiStyleLabelMiddle);
    }
}
