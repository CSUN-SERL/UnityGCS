...
public class GVRSourceDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUILayout.Label("AudioStream v " + AudioStream.About.version + " © 2016-2018 Martin Cvengros, using FMOD Studio by Firelight Technologies" + (this.gVRSource ? " " + this.gVRSource.fmodVersion : ""), this.guiStyleLabelMiddle);
    }
}