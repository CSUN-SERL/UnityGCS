...
public class AudioStreamDemo : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUILayout.Label("AudioStream v " + AudioStream.About.version + " © 2016-2018 Martin Cvengros, using FMOD Studio by Firelight Technologies" + (this.audioStreams != null && this.audioStreams.Length > 0 ? " " + this.audioStreams[0].fmodVersion : ""), this.guiStyleLabelMiddle);
