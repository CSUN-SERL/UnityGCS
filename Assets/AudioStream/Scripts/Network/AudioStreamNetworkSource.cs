...
namespace AudioStream
{
    ...
    public abstract class AudioStreamNetworkSource : MonoBehaviour
    {
        ...
        #region Non editor
        /// <summary>
        /// Encoded packets, read by networking descendant
        /// </summary>
        protected ThreadSafeQueue<byte[]> networkQueue = new ThreadSafeQueue<byte[]>();
        /// <summary>
        ...
        {
            this.encodeThread = new Thread(new ThreadStart(this.EncodeLoop));
        ...
        object audioSamplesLock = new object();
        /// <summary>
        /// Samples to be encoded queue
        /// </summary>
        BasicBuffer<short> audioSamples = new BasicBuffer<short>(10000); // should be enough (tm) for audio to be picked up by decoder
        /// <summary>
        ...
        protected virtual void Awake()
        {
            ...
            this.serverchannels = AudioStreamSupport.ChannelsFromAudioSpeakerMode(ac.speakerMode);
