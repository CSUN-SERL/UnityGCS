...
namespace Survey
{
    public static class ActivateSurveyWithNumber
    {
        public static void Adaptive()
        {
            ...
            switch (surveyNumber)
            {
                ...
                case 19:
                    ...
                    break;
                case 20:
                    Debug.Log("ActivateSurveyWithNumbers calls OnLoad 20");
                    EventManager.OnLoad(21);
                    break;
                default:
                    Debug.Log("ActivateSurveyWithNumbers to load");
                    EventManager.OnEnd();
                    break;
            }
        }
        ...
        {
            var adaptive = ParticipantBehavior.Participant.Data.Adaptive;
            Debug.Log(adaptive + "= adaptive");
