...
public class MissedDetectionButton : MonoBehaviour
{
    ...
    void OnButtonClick1()
    {
        var str = new StringMsg("Miguelito #1");
        Debug.Log(str);
        _rosA.Publish("/coffee", _msg);
        _rosA.Render();
    }
    void OnButtonClick2()
    {
        var str = new StringMsg("Miguelito #2");
        Debug.Log(str);
        _rosA.Publish("/coffee", _msg);
        _rosA.Render();
    }
    void OnButtonClick3()
    {
        var str = new StringMsg("Miguelito #3");
        _rosA.Publish("/coffee", _msg);
    ...
    void OnButtonClick4()
    {
        var str = new StringMsg("Miguelito #4");
        _rosA.Publish("/coffee", _msg);
